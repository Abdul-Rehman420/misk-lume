        ...
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="mt-6 flex items-center gap-3">
              <a
                href="https://www.facebook.com/share/1EZZNbC8hm/"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/misklume?utm_source=qr&igsi=MW14bmQ2ZmN4MG1tcQ%3D%3D"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.tiktok.com/@misk.lume?_r=1&_t=ZS-98s2eNarJTB"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="TikTok"
                className="flex h-9 w-9 items-center justify-center rounded-full border border-border-subtle text-text-muted transition-all hover:border-accent-gold hover:text-accent-gold"
