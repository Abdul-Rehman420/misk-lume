    ...
    <aside className="flex w-64 flex-col border-r border-admin-border bg-admin-surface">
      <div className="flex items-center border-b border-admin-border px-6 py-5">
        <Link href="/admin" className="flex items-center gap-0">
          <span className="font-display text-xl font-semibold text-admin-text">Misk</span>
          <span className="font-display text-xl font-semibold text-accent-gold">Lume</span>
        </Link>
              ...
              <li key={link.href}>
                <Link
                  ...
                  className={`flex items-center gap-3 rounded-md px-4 py-2.5 text-sm font-medium transition-colors ${
                    isActive ? "bg-accent-gold-muted text-accent-gold" : "text-admin-text-muted hover:bg-admin-bg hover:text-admin-text"
                  }`}
                >
                  {link.icon}
                  {link.label}
      ...
      <div className="border-t border-admin-border p-3">
        <Link
          href="/"
          className="flex items-center gap-3 rounded-md px-4 py-2.5 text-sm font-medium text-admin-text-muted transition-colors hover:bg-admin-bg hover:text-admin-text"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5">
